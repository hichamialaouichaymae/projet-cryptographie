...
class IsogenyClassifier(nn.Module):
    def __init__(self, num_classes=1001): # CORRECTION ICI : 1001
...
model = IsogenyClassifier(num_classes=1001).to(device) # CORRECTION ICI : 1001
...
metrics = {
    ...
    "input_features": 10,
    "output_classes": 1001, # CORRECTION ICI : 1001
